...
const Header = () => {
  return (
    ...
    text-gray-800'>
        ...
        gap-2 text-xl sm:text-3xl'>Hey Developer <img className='w-8 aspect-square' src={assets.hand_wave} alt="" /></h1>
        ...
        <button className='border border-gray-500 rounder-full px-8 py-2.5
